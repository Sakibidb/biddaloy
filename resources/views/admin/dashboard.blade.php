            ...
            <div class="card-body">
              <div class="team-list">
                  <div class="d-flex align-items-center gap-3">
                    <div class="">
                      <img src="{{asset('public/assets/images/avatars/01.png')}}" alt="" width="50" height="50" class="rounded-circle">
                    </div>
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="">
                      <img src="{{asset('public/assets/images/avatars/02.png')}}" alt="" width="50" height="50" class="rounded-circle">
                    </div>
                     <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="">
                      <img src="{{asset('public/assets/images/avatars/03.png')}}" alt="" width="50" height="50" class="rounded-circle">
                    </div>
                     <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="">
                      <img src="{{asset('public/assets/images/avatars/04.png')}}" alt="" width="50" height="50" class="rounded-circle">
                    </div>
                     <div class="flex-grow-1">
                       <h6 class="mb-1 fw-bold">Alex Smith</h6>
              ...
              <div class="team-list">
                  <div class="d-flex align-items-center gap-3">
                    <div class="widget-icon bg-transparent border rounded-3">
                      <img src="{{asset('public/assets/images/icons/apple.png')}}" alt="" width="30">
                    </div>
                     <div class="flex-grow-1">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="widget-icon bg-transparent border rounded-3">
                      <img src="{{asset('public/assets/images/icons/bootstrap.png')}}" alt="" width="30">
                    </div>
                     <div class="flex-grow-1">
                      <p class="mb-2 fw-bold">Angular 12 Dashboard</p>
                      <div class="progress" style="height: 5px;">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="widget-icon bg-transparent border rounded-3">
                      <img src="{{asset('public/assets/images/icons/google-2.png')}}" alt="" width="30">
                    </div>
                     <div class="flex-grow-1">
                      <p class="mb-2 fw-bold">Angular 12 Dashboard</p>
                      <div class="progress" style="height: 5px;">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="widget-icon bg-transparent border rounded-3">
                      <img src="{{asset('public/assets/images/icons/spotify.png')}}" alt="" width="30">
                    </div>
                     <div class="flex-grow-1">
                      <p class="mb-2 fw-bold">Angular 12 Dashboard</p>
                      <div class="progress" style="height: 5px;">
                  ...
                  <div class="d-flex align-items-center gap-3">
                    <div class="widget-icon bg-transparent border rounded-3">
                      <img src="{{asset('public/assets/images/icons/outlook.png')}}" alt="" width="30">
                    </div>
                     <div class="flex-grow-1">
                      <p class="mb-2 fw-bold">Angular 12 Dashboard</p>
                      <div class="progress" style="height: 5px;">
                 ...
                 <tbody>
                     ...
                     <td>
                      <a class="d-flex align-items-center gap-3" href="javascript:;">
                        <div class="customer-pic">
                          <img src="{{asset('public/assets/images/avatars/01.png')}}" class="rounded-circle" width="40" height="40" alt="">
                        </div>
                   ...
                   <tr>
                    ...
                    <td>
                     <a class="d-flex align-items-center gap-3" href="javascript:;">
                       <div class="customer-pic">
                         <img src="{{asset('public/assets/images/avatars/02.png')}}" class="rounded-circle" width="40" height="40" alt="">
                       </div>
                       <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                     </a>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                     <a class="d-flex align-items-center gap-3" href="javascript:;">
                       <div class="customer-pic">
                         <img src="{{asset('public/assets/images/avatars/03.png')}}" class="rounded-circle" width="40" height="40" alt="">
                       </div>
                       <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                     </a>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                     <a class="d-flex align-items-center gap-3" href="javascript:;">
                       <div class="customer-pic">
                         <img src="{{asset('public/assets/images/avatars/04.png')}}" class="rounded-circle" width="40" height="40" alt="">
                       </div>
                       <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                     </a>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                     <a class="d-flex align-items-center gap-3" href="javascript:;">
                       <div class="customer-pic">
                         <img src="{{asset('public/assets/images/avatars/05.png')}}" class="rounded-circle" width="40" height="40" alt="">
                       </div>
                       <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                     </a>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                     <a class="d-flex align-items-center gap-3" href="javascript:;">
                       <div class="customer-pic">
                         <img src="{{asset('public/assets/images/avatars/06.png')}}" class="rounded-circle" width="40" height="40" alt="">
                       </div>
                       <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                     </a>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                     <a class="d-flex align-items-center gap-3" href="javascript:;">
                       <div class="customer-pic">
                         <img src="{{asset('public/assets/images/avatars/07.png')}}" class="rounded-circle" width="40" height="40" alt="">
                       </div>
                       <p class="mb-0 customer-name fw-bold">Andrew Carry</p>
                     </a>
                    </td>
